...
ExitSetupTitle=Exit Support Tool
ExitSetupMessage=Support Tool has not finished gathering the information.%n%nExit now?
...
WizardSelectComponents=Select Options Or Actions
SelectComponentsDesc=Information to add to Support Tool or actions to perform
SelectComponentsLabel2=Select either the additional information types to include in the archive created by the Support Tool or an action to be performed.
...
ComponentsDiskSpaceMBLabel=Note: Each of the Options above will increase the size of the generated archive.

; *** "Select Additional Tasks" wizard page
WizardSelectTasks=Select Additional Tasks
SelectTasksDesc=Which additional tasks should be performed?
SelectTasksLabel2=Select the additional tasks you would like [name] to perform, then click Next.
